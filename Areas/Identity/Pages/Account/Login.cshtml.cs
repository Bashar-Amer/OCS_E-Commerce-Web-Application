...
public class LoginModel : PageModel
{
    ...
    public async Task OnGetAsync(string? returnUrl = null)
    {
        ...
        // If no explicit returnUrl was provided in query string, check the Referer header
        if (string.IsNullOrEmpty(returnUrl))
        {
                ...
                string.Equals(refererUri.Host, Request.Host.Host, StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (!localPath.Contains("/Identity/Account/Login", StringComparison.OrdinalIgnoreCase) && 
                    !localPath.Contains("/Identity/Account/Register", StringComparison.OrdinalIgnoreCase) &&
                    !localPath.Contains("/Identity/Account/Logout", StringComparison.OrdinalIgnoreCase))
                {
                    returnUrl = localPath;
                }
            }
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // 1. Role-Based Redirection: Admin -> Admin Dashboard
                ...
                // 2. Regular User / Customer Redirection: Return to last visited page
                if (!string.IsNullOrEmpty(returnUrl) && 
